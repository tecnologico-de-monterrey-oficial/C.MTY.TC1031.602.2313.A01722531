...
void createListInt(LinkedList<int> &listInt, int quantity){
...
void listInt(LinkedList<int> &listInt){
    int n = 0;
...
void listString(LinkedList<string> &listString){
    int n = 0;
    cout << "Quisieras que la lista se genere de manera:" << endl;
    cout << "1. Aleatoria" << endl;
    cout << "2. Manual" << endl;
...
template<class T>
void options(LinkedList<T>& list) {
    int option;
    do {
