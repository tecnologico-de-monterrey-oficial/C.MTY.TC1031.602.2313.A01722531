...
void menu(Graph<string> &graph) {
  ...
  do {
    ...
    switch (opcion) {
    case 1:
      graph.Sort("output602-1.txt");
      cout << "output602-1.txt generado" << endl;
      break;
    case 2:
      graph.print("output602-2.txt");
      cout << "output602-2.txt generado" << endl;
      break;
    case 3:
      {string vertex;
      cout << "Ciudad de salida: ";
      cin >> vertex;
      graph.bfs(vertex, "output602-3.txt");
      graph.dfs(vertex, "output602-4.txt");
      break;}
    case 4:
      {string cityA, cityB;
      cout << "Primera ciudad: ";
